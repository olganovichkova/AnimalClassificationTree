package test.java.edu.isu.cs2235.structures.impl;
...
public class LinkedBinaryTreeTest {
    ...
    public void testCreateNode_2() {
        LinkedBinaryTree.BinaryTreeNode<Integer> root = fixture.createNode(0, null, null, null);
        LinkedBinaryTree.BinaryTreeNode<Integer> node = fixture.createNode(0, root, null, null);
        assertNotNull(node);
...
//    }
    ...
    /**
     * Test of subTreeSize method, of class LinkedGeneralTree.
     */
    @Test
    public void testSubTreeSize() {
        ...
        fixture.insert(5, two);
        Node<Integer> last = fixture.insert(7, two);
        assertEquals("Wrong number of children returned for node", 6, fixture.subTreeSize(root));
    }
}
